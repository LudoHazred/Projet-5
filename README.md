...
Ce programme permet de récupérer les aliments de la base de donnée d'Open Food Facts, les comparer et proposer à l'utilisateur un substitut plus sain à l'aliment qui lui fait envie.
...
Si l'utilisateur sélectionne 2, le programme affiche le résultat des recherchez déjà effectués permettant ainsi d'éviter de refaire une recherche dans la base de donnée.
